...
socket.on('returnCheck1', function(result)
{
	...
	if(player1chara.value=="miifighter" || player1chara.value=="miiswordsman" || player1chara.value=="miigunner")
	{
		...
		{
			document.getElementById("p1Preview").src="./node_modules/resources/stocks/chara_2_"+player1chara.value+"_00.png";
		}
	}
	else
	{
		...
		{
			document.getElementById("p1Preview").src="./node_modules/resources/stocks/chara_2_"+player1chara.value+"_0"+player1alt.value+".png";
		}
	}
...
socket.on('returnCheck2', function(result)
{
	...
	if(player2chara.value=="miifighter" || player2chara.value=="miiswordsman" || player2chara.value=="miigunner")
	{
		...
		{
			document.getElementById("p2Preview").src="./node_modules/resources/stocks/chara_2_"+player2chara.value+"_00.png";
		}
	}
	else
	{
		...
		{
			document.getElementById("p2Preview").src="./node_modules/resources/stocks/chara_2_"+player2chara.value+"_0"+player2alt.value+".png";
		}
	}
...
$('#top8').click(function()
{
	var values = Array.from(document.getElementById("p1Char").options).map(e => e.value);
	console.log(values);
	//document.getElementById("container").innerHTML = values;
});
...
$('#updateP1').click(function(s,err)
{
	...
	{
		s.preventDefault();
		socket.emit('stock_update',document.getElementById("p1Char").value,document.getElementById("p1Alt").value,document.getElementById("imageSet").value,"1");
...
/*$('#imageSet').change(function(ic)
{
	var type=document.getElementById("imageSet").value;
	...
	document.getElementById("p1Preview").src="./node_modules/resources/"+locate+"/chara_"+type+"_"+player1chara.value+"_0"+player1alt+".png";
	document.getElementById("p2Preview").src="./node_modules/resources/"+locate+"/chara_"+type+"_"+player2chara.value+"_0"+player2alt+".png";
